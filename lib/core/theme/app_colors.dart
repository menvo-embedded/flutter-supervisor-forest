...
class AppColors {
  ...
  static Color getBg([bool isDark = false]) {
    return isDark ? bgDark : bg;
  }

  static Color getSurface([bool isDark = false]) {
    return isDark ? surfaceDark : surface;
  }

  static Color getSurfaceGrey([bool isDark = false]) {
    return isDark ? surfaceGreyDark : surfaceGrey;
  }

  static Color getTextPrimary([bool isDark = false]) {
    return isDark ? textPrimaryDark : textPrimary;
  }

  static Color getTextSecondary([bool isDark = false]) {
    return isDark ? textSecondaryDark : textSecondary;
  }

  static Color getBorder([bool isDark = false]) {
    return isDark ? borderDark : borderDefault;
  }
}